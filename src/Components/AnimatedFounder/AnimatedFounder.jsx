                    ...
                    <div className="meetFounderContainer" style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                        <div className="MainheadingContainer">
                            <h1 className="MainHeading" data-aos="fade-up"
                                data-aos-duration="1000" data-aos-delay="100">Meet the <span>host</span></h1>
                        </div>
                    </div>
                    <div className="Animated">
                        <div>
                            <LazyLoadImage data-aos="fade-up"
                                data-aos-duration="1000" data-aos-delay="200" effect="blur" src="https://images.unsplash.com/photo-1544719576-904e2d01e057?q=80&w=3000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Podcast recording setup with microphone" threshold={300}
